...
- GlomWindow : A window (in the clock ticks of the V2740) to look for correlated events from RawRing to push into EventRing.
  ...
  - As an example:
      ...
      - If GlomWindow = 1, and two channesl fire with a time difference of 10 ns, **neither** of the traces will be sent to EventRing.
- SourceID : Refer to the FRIBDAQ documentation for more information.
